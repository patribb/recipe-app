<template>
  <div class="home">
    <h1>Mis Recetas</h1>
    <button @click="togglePopup">Añadir nueva Receta</button>
    <div class="recipes">
      ...
      <div class="popup-content">
        ...
        <form @submit.prevent="addNewRecipe">
          ...
          <div class="group">
            ...
            <button type="button" @click="addNewingredient">Añadir ingrediente</button>
          </div>
          ...
          <div class="group">
            ...
            <button type="button" @click="addNewStep">Añadir paso</button>
          </div>
          <button type="submit">Crear Receta</button>
          <button type="button" @click="togglePopup">Cerrar</button>
        </form>
      </div>
    </div>
  </div>
  ...
  setup() {
    ...
    const addNewRecipe = () => {
      ...
      if(newRecipe.value.slug == '') {
        alert('Por favor, indica un título para la receta');
        return;
      }
